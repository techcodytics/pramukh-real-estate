    ...
    <div className="bg-white min-h-screen mandala-bg">
              ...
              <Link href={`/projects/${project.id}`}>
                ...
                <div className="flex justify-between items-end border-b border-stone/10 pb-10">
                  <div>
                    ...
                    <h3 className="text-4xl lg:text-5xl font-serif text-stone mb-4 group-hover:text-gold transition-colors duration-500">
                      {project.title}
                    </h3>
      ...
      <section className="bg-stone py-32 px-6 lg:px-24 overflow-hidden relative">
        ...
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <Link
            href="/inquiry"
            className="serene-button inline-flex items-center gap-4 bg-gold! hover:bg-white! hover:text-stone!"
          >
