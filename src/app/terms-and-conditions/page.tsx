        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <div>
            <h3 className="text-3xl font-serif text-stone mb-8">
              Respect & <span className="italic text-gold">Honesty.</span>
            </h3>
            <p className="text-stone/70 font-sans font-light leading-relaxed mb-6">
              Welcome to our website. If you continue to browse and use this
              website, you are agreeing to comply with and be bound by the
              following terms and conditions of use, which together with our
              privacy policy govern Pramukh Group&apos;s relationship with you
          ...
          <div>
            ...
            <p className="text-stone/70 font-sans font-light leading-relaxed">
              All images and artistic renderings of properties are for
              illustrative purposes. Actual appearance, including layout and
              finishes, are subject to change as our projects evolve. All
              projects are RERA registered.
            </p>
          </div>

          <div className="pt-10 border-t border-stone/10 italic text-stone/40 text-sm">
            Last Updated: April 2026. This agreement reflects our commitment to
