        ...
        <div>
           ...
           <div className="space-y-6 pt-4 border-t border-stone/5">
              <div className="flex items-start gap-4">
                <MapPin size={16} strokeWidth={1.5} className="text-gold shrink-0 mt-1" />
                <div className="flex flex-col">
                  <span className="text-[10px] font-sans font-bold uppercase tracking-widest text-stone/40 mb-1">Sanctuary Location</span>
                  <span className="text-sm font-sans font-medium text-stone/70">{location}, {city}</span>
                </div>
              </div>
              
              <div className="flex items-start gap-4">
                <Building2 size={16} strokeWidth={1.5} className="text-gold shrink-0 mt-1" />
                <div className="flex flex-col">
                  <span className="text-[10px] font-sans font-bold uppercase tracking-widest text-stone/40 mb-1">Configuration</span>
                  <span className="text-sm font-sans font-medium text-stone/70">{config}</span>
                </div>
              </div>
           </div>
        </div>
